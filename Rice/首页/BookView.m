...
//                _bgView.contentMode = UIViewContentModeScaleAspectFill;
        ...
        [_cuiDanBtn addTarget:self action:@selector(cuiDanAction) forControlEvents:UIControlEventTouchUpInside];

        
        // 蒙版
        _maskBtn = [UIButton buttonWithframe:CGRectMake(_cancelBtn.right, _cancelBtn.top, _cancelBtn.width, 44) text:@"" font:SystemFont(15) textColor:@"#666666" backgroundColor:nil normal:@"" selected:nil];
